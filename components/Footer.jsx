...
const Footer = () => {
    ...
    const MailIcon = () => (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M14.6654 4.66699L8.67136 8.48499C8.46796 8.60313 8.23692 8.66536 8.0017 8.66536C7.76647 8.66536 7.53544 8.60313 7.33203 8.48499L1.33203 4.66699" stroke="#90A1B9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M2.66536 2.66699H13.332C14.0684 2.66699 14.6654 3.26395 14.6654 4.00033V12.0003C14.6654 12.7367 14.0684 13.3337 13.332 13.3337H2.66536C1.92898 13.3337 1.33203 12.7367 1.33203 12.0003V4.00033C1.33203 3.26395 1.92898 2.66699 2.66536 2.66699Z" stroke="#90A1B9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    );

    const PhoneIcon = () => (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M9.22003 11.045C10.1494 14.6663 13.332 14.6663 13.332 14.6663C13.6857 14.6663 14.0248 14.5259 14.2748 14.2758C14.5249 14.0258 14.6654 13.6866 14.6654 13.333V11.333C14.6654 10.9794 14.5249 10.6402 14.2748 10.3902C14.0248 10.1402 13.6857 9.99967 13.332 9.99967H11.332" stroke="#90A1B9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M5.9987 2.66634V4.66634C5.9987 5.07749 5.85793 5.44777 5.46536 5.73301L5.15336 5.96701C4.89122 6.65059 5.86982 8.63959 9.22003 11.045" stroke="#90A1B9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
    );
