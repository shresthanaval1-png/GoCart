...
import { HomeIcon, ShieldCheckIcon, StoreIcon, TicketPercentIcon, MailIcon } from "lucide-react" // ✅ added MailIcon
...
const AdminSidebar = () => {
    ...
    const sidebarLinks = [
        ...
        // ✅ NEW LINK ADDED
        { name: 'Customer Messages', href: '/admin/messages', icon: MailIcon },
    ]
