                    ...
                    <div className="hidden sm:flex items-center gap-4 lg:gap-8 text-slate-600">
                        ...
                        {isSeller && (
                            <button
                                ...
                                className="ml-2 bg-green-600 text-white px-4 py-2 rounded-md text-sm hover:bg-green-700 transition"
                            >
                                Seller Dashboard
                            </button>
                        )}
                        ...
                        {user ? (
                            <div>
                                ...
                                {isSeller && (
                                    <button
                                        onClick={() => router.push('/store')}
                                        className="mb-2 bg-green-600 text-white px-3 py-1 rounded text-xs"
                                    >
                                        Seller Dashboard
                                    </button>
                                )}
